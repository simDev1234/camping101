...
- 원인 : SpringSecurity의 기본 AuthenticationProvider를 확장한 'UsernamePasswordAuthenticationProvider'클래스의 supports 메소드에 'UsernamePasswordAuthenticaionToken'을 지정해주지 않아서 나타난 이슈였다. 일단 SpringSecurity의 기본 UsernamePassword 인증 절차를 풀이하면 다음과 같았다. <br>
  ```bash
